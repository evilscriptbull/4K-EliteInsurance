      ...
      {pages.map((page) => (
        <Link key={page.slug} href={page.slug}>
          <Card className="h-full transition-shadow hover:shadow-md">
            <InsuranceLineIcon line={page.insuranceLine} className="size-8 text-brand-800 duotone-accent-200" />
            <h3 className="mt-3 font-serif text-base font-semibold text-brand-900">{page.label}</h3>
